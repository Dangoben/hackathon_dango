...
<body>
  ...
  <div id="login-page">
    <div class="container">
      <form class="form-login" action="S_login.php" method="post">
        <h2 class="form-login-heading">Connectez-vous maintenant</h2>
        <div class="login-wrap">
          <input type="text" name="mail" class="form-control" placeholder="Entrez votre email" autofocus>
          <br>
          ...
          <div class="registration">
            Vous-êtes pas encore inscript ?<br/>
